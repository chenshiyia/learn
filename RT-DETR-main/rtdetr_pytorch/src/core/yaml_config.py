...
class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        # 传入配置文件路径
        super().__init__()
        # 解析配置文件中的各项参数,返回一个字典cfg接受参数
        cfg = load_config(cfg_path)
        # 将cfg和train脚本中传入的参数合并到cfg中
...
if __name__ == '__main__':
    cfg = YAMLConfig(r'F:\LearnDL\RT-DETR-main\RT-DETR-main\rtdetr_pytorch\configs\rtdetr\rtdetr_r18vd_6x_coco.yml')
